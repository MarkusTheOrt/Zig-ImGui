...
CIMGUI_API ImVec2* ImVec2_ImVec2_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImVec2();
}
CIMGUI_API void ImVec2_destroy(ImVec2* self)
{
    self->~ImVec2();
}
CIMGUI_API ImVec2* ImVec2_ImVec2_Float(void* self,float _x,float _y)
{
    return IM_PLACEMENT_NEW(self) ImVec2(_x,_y);
}
CIMGUI_API ImVec4* ImVec4_ImVec4_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImVec4();
}
CIMGUI_API void ImVec4_destroy(ImVec4* self)
{
    self->~ImVec4();
}
CIMGUI_API ImVec4* ImVec4_ImVec4_Float(void* self,float _x,float _y,float _z,float _w)
{
    return IM_PLACEMENT_NEW(self) ImVec4(_x,_y,_z,_w);
}
...
CIMGUI_API ImGuiStyle* ImGuiStyle_ImGuiStyle(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiStyle();
}
...
CIMGUI_API ImGuiIO* ImGuiIO_ImGuiIO(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiIO();
}
CIMGUI_API void ImGuiIO_destroy(ImGuiIO* self)
{
    self->~ImGuiIO();
}
CIMGUI_API ImGuiInputTextCallbackData* ImGuiInputTextCallbackData_ImGuiInputTextCallbackData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiInputTextCallbackData();
}
...
CIMGUI_API ImGuiPayload* ImGuiPayload_ImGuiPayload(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiPayload();
}
...
CIMGUI_API ImGuiTableColumnSortSpecs* ImGuiTableColumnSortSpecs_ImGuiTableColumnSortSpecs(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableColumnSortSpecs();
}
CIMGUI_API void ImGuiTableColumnSortSpecs_destroy(ImGuiTableColumnSortSpecs* self)
{
    self->~ImGuiTableColumnSortSpecs();
}
CIMGUI_API ImGuiTableSortSpecs* ImGuiTableSortSpecs_ImGuiTableSortSpecs(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableSortSpecs();
}
CIMGUI_API void ImGuiTableSortSpecs_destroy(ImGuiTableSortSpecs* self)
{
    self->~ImGuiTableSortSpecs();
}
CIMGUI_API ImGuiOnceUponAFrame* ImGuiOnceUponAFrame_ImGuiOnceUponAFrame(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiOnceUponAFrame();
}
CIMGUI_API void ImGuiOnceUponAFrame_destroy(ImGuiOnceUponAFrame* self)
{
    self->~ImGuiOnceUponAFrame();
}
CIMGUI_API ImGuiTextFilter* ImGuiTextFilter_ImGuiTextFilter(void* self,const char* default_filter)
{
    return IM_PLACEMENT_NEW(self) ImGuiTextFilter(default_filter);
}
...
CIMGUI_API bool ImGuiTextFilter_PassFilter(const ImGuiTextFilter* self,const char* text,const char* text_end)
{
...
CIMGUI_API ImGuiTextRange* ImGuiTextRange_ImGuiTextRange_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTextRange();
}
CIMGUI_API void ImGuiTextRange_destroy(ImGuiTextRange* self)
{
    self->~ImGuiTextRange();
}
CIMGUI_API ImGuiTextRange* ImGuiTextRange_ImGuiTextRange_Str(void* self,const char* _b,const char* _e)
{
    return IM_PLACEMENT_NEW(self) ImGuiTextRange(_b,_e);
}
CIMGUI_API bool ImGuiTextRange_empty(const ImGuiTextRange* self)
{
    return self->empty();
}
CIMGUI_API void ImGuiTextRange_split(const ImGuiTextRange* self,char separator,ImVector_ImGuiTextRange* out)
{
    return self->split(separator,out);
}
CIMGUI_API ImGuiTextBuffer* ImGuiTextBuffer_ImGuiTextBuffer(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTextBuffer();
}
...
CIMGUI_API const char* ImGuiTextBuffer_end(const ImGuiTextBuffer* self)
{
    return self->end();
}
...
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Int(void* self,ImGuiID _key,int _val_i)
{
    return IM_PLACEMENT_NEW(self) ImGuiStoragePair(_key,_val_i);
}
CIMGUI_API void ImGuiStoragePair_destroy(ImGuiStoragePair* self)
{
    self->~ImGuiStoragePair();
}
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Float(void* self,ImGuiID _key,float _val_f)
{
    return IM_PLACEMENT_NEW(self) ImGuiStoragePair(_key,_val_f);
}
CIMGUI_API ImGuiStoragePair* ImGuiStoragePair_ImGuiStoragePair_Ptr(void* self,ImGuiID _key,void* _val_p)
{
    return IM_PLACEMENT_NEW(self) ImGuiStoragePair(_key,_val_p);
}
CIMGUI_API void ImGuiStorage_Clear(ImGuiStorage* self)
{
    return self->Clear();
}
CIMGUI_API int ImGuiStorage_GetInt(const ImGuiStorage* self,ImGuiID key,int default_val)
{
...
CIMGUI_API bool ImGuiStorage_GetBool(const ImGuiStorage* self,ImGuiID key,bool default_val)
{
...
CIMGUI_API float ImGuiStorage_GetFloat(const ImGuiStorage* self,ImGuiID key,float default_val)
{
...
CIMGUI_API void* ImGuiStorage_GetVoidPtr(const ImGuiStorage* self,ImGuiID key)
{
...
CIMGUI_API ImGuiListClipper* ImGuiListClipper_ImGuiListClipper(void* self)
{
...
CIMGUI_API ImColor* ImColor_ImColor_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImColor();
}
CIMGUI_API void ImColor_destroy(ImColor* self)
{
    self->~ImColor();
}
CIMGUI_API ImColor* ImColor_ImColor_Float(void* self,float r,float g,float b,float a)
{
...
CIMGUI_API ImColor* ImColor_ImColor_U32(void* self,ImU32 rgba)
{
    return IM_PLACEMENT_NEW(self) ImColor(rgba);
}
...
CIMGUI_API ImDrawCmd* ImDrawCmd_ImDrawCmd(void* self)
{
    return IM_PLACEMENT_NEW(self) ImDrawCmd();
}
...
CIMGUI_API ImDrawListSplitter* ImDrawListSplitter_ImDrawListSplitter(void* self)
{
    return IM_PLACEMENT_NEW(self) ImDrawListSplitter();
}
...
CIMGUI_API ImDrawList* ImDrawList_ImDrawList(void* self,const ImDrawListSharedData* shared_data)
{
    return IM_PLACEMENT_NEW(self) ImDrawList(shared_data);
}
...
CIMGUI_API void ImDrawList_GetClipRectMin(ImVec2 *pOut,const ImDrawList* self)
{
    *pOut = self->GetClipRectMin();
}
CIMGUI_API void ImDrawList_GetClipRectMax(ImVec2 *pOut,const ImDrawList* self)
{
...
CIMGUI_API ImDrawList* ImDrawList_CloneOutput(const ImDrawList* self)
{
...
{
    return IM_PLACEMENT_NEW(self) ImDrawData();
}
...
{
    return IM_PLACEMENT_NEW(self) ImFontConfig();
}
CIMGUI_API void ImFontConfig_destroy(ImFontConfig* self)
{
    self->~ImFontConfig();
}
CIMGUI_API ImFontGlyphRangesBuilder* ImFontGlyphRangesBuilder_ImFontGlyphRangesBuilder(void* self)
{
    return IM_PLACEMENT_NEW(self) ImFontGlyphRangesBuilder();
}
...
CIMGUI_API bool ImFontGlyphRangesBuilder_GetBit(const ImFontGlyphRangesBuilder* self,size_t n)
{
...
CIMGUI_API ImFontAtlasCustomRect* ImFontAtlasCustomRect_ImFontAtlasCustomRect(void* self)
{
    return IM_PLACEMENT_NEW(self) ImFontAtlasCustomRect();
}
...
CIMGUI_API ImFontAtlas* ImFontAtlas_ImFontAtlas(void* self)
{
    return IM_PLACEMENT_NEW(self) ImFontAtlas();
}
...
CIMGUI_API bool ImFontAtlas_IsBuilt(const ImFontAtlas* self)
{
    return self->IsBuilt();
}
...
CIMGUI_API ImFont* ImFont_ImFont(void* self)
{
    return IM_PLACEMENT_NEW(self) ImFont();
}
...
CIMGUI_API void ImFont_CalcTextSizeA(ImVec2 *pOut,const ImFont* self,float size,float max_width,float wrap_width,const char* text_begin,const char* text_end,const char** remaining)
{
...
CIMGUI_API ImGuiViewport* ImGuiViewport_ImGuiViewport(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiViewport();
}
CIMGUI_API void ImGuiViewport_destroy(ImGuiViewport* self)
{
    self->~ImGuiViewport();
}
CIMGUI_API void ImGuiViewport_GetCenter(ImVec2 *pOut,const ImGuiViewport* self)
{
    *pOut = self->GetCenter();
}
CIMGUI_API void ImGuiViewport_GetWorkCenter(ImVec2 *pOut,const ImGuiViewport* self)
{
    *pOut = self->GetWorkCenter();
}
CIMGUI_API ImGuiPlatformImeData* ImGuiPlatformImeData_ImGuiPlatformImeData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiPlatformImeData();
}
CIMGUI_API void ImGuiPlatformImeData_destroy(ImGuiPlatformImeData* self)
{
    self->~ImGuiPlatformImeData();
}
...
CIMGUI_API ImVec1* ImVec1_ImVec1_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImVec1();
}
CIMGUI_API void ImVec1_destroy(ImVec1* self)
{
    self->~ImVec1();
}
CIMGUI_API ImVec1* ImVec1_ImVec1_Float(void* self,float _x)
{
    return IM_PLACEMENT_NEW(self) ImVec1(_x);
}
CIMGUI_API ImVec2ih* ImVec2ih_ImVec2ih_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImVec2ih();
}
CIMGUI_API void ImVec2ih_destroy(ImVec2ih* self)
{
    self->~ImVec2ih();
}
CIMGUI_API ImVec2ih* ImVec2ih_ImVec2ih_short(void* self,short _x,short _y)
{
    return IM_PLACEMENT_NEW(self) ImVec2ih(_x,_y);
}
CIMGUI_API ImVec2ih* ImVec2ih_ImVec2ih_Vec2(void* self,const ImVec2* rhs)
{
    return IM_PLACEMENT_NEW(self) ImVec2ih(*rhs);
}
CIMGUI_API ImRect* ImRect_ImRect_Nil(void* self)
{
    return IM_PLACEMENT_NEW(self) ImRect();
}
CIMGUI_API void ImRect_destroy(ImRect* self)
{
    self->~ImRect();
}
CIMGUI_API ImRect* ImRect_ImRect_Vec2(void* self,const ImVec2* min,const ImVec2* max)
{
    return IM_PLACEMENT_NEW(self) ImRect(*min,*max);
}
CIMGUI_API ImRect* ImRect_ImRect_Vec4(void* self,const ImVec4* v)
{
    return IM_PLACEMENT_NEW(self) ImRect(*v);
}
CIMGUI_API ImRect* ImRect_ImRect_Float(void* self,float x1,float y1,float x2,float y2)
{
    return IM_PLACEMENT_NEW(self) ImRect(x1,y1,x2,y2);
}
CIMGUI_API void ImRect_GetCenter(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetCenter();
}
CIMGUI_API void ImRect_GetSize(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetSize();
}
...
CIMGUI_API void ImRect_GetTL(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetTL();
}
CIMGUI_API void ImRect_GetTR(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetTR();
}
CIMGUI_API void ImRect_GetBL(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetBL();
}
CIMGUI_API void ImRect_GetBR(ImVec2 *pOut,const ImRect* self)
{
    *pOut = self->GetBR();
}
CIMGUI_API bool ImRect_Contains_Vec2(const ImRect* self,const ImVec2* p)
{
    return self->Contains(*p);
}
CIMGUI_API bool ImRect_Contains_Rect(const ImRect* self,const ImRect* r)
{
    return self->Contains(*r);
}
CIMGUI_API bool ImRect_Overlaps(const ImRect* self,const ImRect* r)
{
...
CIMGUI_API void ImRect_ToVec4(ImVec4 *pOut,const ImRect* self)
{
    *pOut = self->ToVec4();
}
...
CIMGUI_API ImDrawListSharedData* ImDrawListSharedData_ImDrawListSharedData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImDrawListSharedData();
}
CIMGUI_API void ImDrawListSharedData_destroy(ImDrawListSharedData* self)
{
    self->~ImDrawListSharedData();
}
...
CIMGUI_API int ImDrawDataBuilder_GetDrawListCount(const ImDrawDataBuilder* self)
{
...
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Int(void* self,ImGuiStyleVar idx,int v)
{
    return IM_PLACEMENT_NEW(self) ImGuiStyleMod(idx,v);
}
CIMGUI_API void ImGuiStyleMod_destroy(ImGuiStyleMod* self)
{
    self->~ImGuiStyleMod();
}
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Float(void* self,ImGuiStyleVar idx,float v)
{
    return IM_PLACEMENT_NEW(self) ImGuiStyleMod(idx,v);
}
CIMGUI_API ImGuiStyleMod* ImGuiStyleMod_ImGuiStyleMod_Vec2(void* self,ImGuiStyleVar idx,const ImVec2* v)
{
    return IM_PLACEMENT_NEW(self) ImGuiStyleMod(idx,*v);
}
CIMGUI_API ImGuiComboPreviewData* ImGuiComboPreviewData_ImGuiComboPreviewData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiComboPreviewData();
}
CIMGUI_API void ImGuiComboPreviewData_destroy(ImGuiComboPreviewData* self)
{
    self->~ImGuiComboPreviewData();
}
CIMGUI_API ImGuiMenuColumns* ImGuiMenuColumns_ImGuiMenuColumns(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiMenuColumns();
}
CIMGUI_API void ImGuiMenuColumns_destroy(ImGuiMenuColumns* self)
{
    self->~ImGuiMenuColumns();
}
...
CIMGUI_API ImGuiInputTextState* ImGuiInputTextState_ImGuiInputTextState(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiInputTextState();
}
CIMGUI_API void ImGuiInputTextState_destroy(ImGuiInputTextState* self)
{
    self->~ImGuiInputTextState();
}
...
CIMGUI_API ImGuiPopupData* ImGuiPopupData_ImGuiPopupData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiPopupData();
}
CIMGUI_API void ImGuiPopupData_destroy(ImGuiPopupData* self)
{
    self->~ImGuiPopupData();
}
CIMGUI_API ImGuiNextWindowData* ImGuiNextWindowData_ImGuiNextWindowData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiNextWindowData();
}
CIMGUI_API void ImGuiNextWindowData_destroy(ImGuiNextWindowData* self)
{
    self->~ImGuiNextWindowData();
}
CIMGUI_API void ImGuiNextWindowData_ClearFlags(ImGuiNextWindowData* self)
{
    return self->ClearFlags();
}
CIMGUI_API ImGuiNextItemData* ImGuiNextItemData_ImGuiNextItemData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiNextItemData();
}
CIMGUI_API void ImGuiNextItemData_destroy(ImGuiNextItemData* self)
{
    self->~ImGuiNextItemData();
}
CIMGUI_API void ImGuiNextItemData_ClearFlags(ImGuiNextItemData* self)
{
    return self->ClearFlags();
}
CIMGUI_API ImGuiLastItemData* ImGuiLastItemData_ImGuiLastItemData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiLastItemData();
}
CIMGUI_API void ImGuiLastItemData_destroy(ImGuiLastItemData* self)
{
    self->~ImGuiLastItemData();
}
CIMGUI_API ImGuiStackSizes* ImGuiStackSizes_ImGuiStackSizes(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiStackSizes();
}
CIMGUI_API void ImGuiStackSizes_destroy(ImGuiStackSizes* self)
{
    self->~ImGuiStackSizes();
}
...
CIMGUI_API ImGuiPtrOrIndex* ImGuiPtrOrIndex_ImGuiPtrOrIndex_Ptr(void* self,void* ptr)
{
    return IM_PLACEMENT_NEW(self) ImGuiPtrOrIndex(ptr);
}
CIMGUI_API void ImGuiPtrOrIndex_destroy(ImGuiPtrOrIndex* self)
{
    self->~ImGuiPtrOrIndex();
}
CIMGUI_API ImGuiPtrOrIndex* ImGuiPtrOrIndex_ImGuiPtrOrIndex_Int(void* self,int index)
{
    return IM_PLACEMENT_NEW(self) ImGuiPtrOrIndex(index);
}
CIMGUI_API ImGuiInputEvent* ImGuiInputEvent_ImGuiInputEvent(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiInputEvent();
}
CIMGUI_API void ImGuiInputEvent_destroy(ImGuiInputEvent* self)
{
    self->~ImGuiInputEvent();
}
...
CIMGUI_API ImGuiListClipperData* ImGuiListClipperData_ImGuiListClipperData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiListClipperData();
}
CIMGUI_API void ImGuiListClipperData_destroy(ImGuiListClipperData* self)
{
    self->~ImGuiListClipperData();
}
CIMGUI_API void ImGuiListClipperData_Reset(ImGuiListClipperData* self,ImGuiListClipper* clipper)
{
    return self->Reset(clipper);
}
CIMGUI_API ImGuiNavItemData* ImGuiNavItemData_ImGuiNavItemData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiNavItemData();
}
CIMGUI_API void ImGuiNavItemData_destroy(ImGuiNavItemData* self)
{
    self->~ImGuiNavItemData();
}
CIMGUI_API void ImGuiNavItemData_Clear(ImGuiNavItemData* self)
{
    return self->Clear();
}
CIMGUI_API ImGuiOldColumnData* ImGuiOldColumnData_ImGuiOldColumnData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiOldColumnData();
}
CIMGUI_API void ImGuiOldColumnData_destroy(ImGuiOldColumnData* self)
{
    self->~ImGuiOldColumnData();
}
CIMGUI_API ImGuiOldColumns* ImGuiOldColumns_ImGuiOldColumns(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiOldColumns();
}
CIMGUI_API void ImGuiOldColumns_destroy(ImGuiOldColumns* self)
{
    self->~ImGuiOldColumns();
}
CIMGUI_API ImGuiViewportP* ImGuiViewportP_ImGuiViewportP(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiViewportP();
}
CIMGUI_API void ImGuiViewportP_destroy(ImGuiViewportP* self)
{
    self->~ImGuiViewportP();
}
CIMGUI_API void ImGuiViewportP_CalcWorkRectPos(ImVec2 *pOut,const ImGuiViewportP* self,const ImVec2* off_min)
{
    *pOut = self->CalcWorkRectPos(*off_min);
}
CIMGUI_API void ImGuiViewportP_CalcWorkRectSize(ImVec2 *pOut,const ImGuiViewportP* self,const ImVec2* off_min,const ImVec2* off_max)
{
...
CIMGUI_API void ImGuiViewportP_GetMainRect(ImRect *pOut,const ImGuiViewportP* self)
{
    *pOut = self->GetMainRect();
}
CIMGUI_API void ImGuiViewportP_GetWorkRect(ImRect *pOut,const ImGuiViewportP* self)
{
    *pOut = self->GetWorkRect();
}
CIMGUI_API void ImGuiViewportP_GetBuildWorkRect(ImRect *pOut,const ImGuiViewportP* self)
{
    *pOut = self->GetBuildWorkRect();
}
CIMGUI_API ImGuiWindowSettings* ImGuiWindowSettings_ImGuiWindowSettings(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiWindowSettings();
}
CIMGUI_API void ImGuiWindowSettings_destroy(ImGuiWindowSettings* self)
{
    self->~ImGuiWindowSettings();
}
CIMGUI_API char* ImGuiWindowSettings_GetName(ImGuiWindowSettings* self)
{
    return self->GetName();
}
CIMGUI_API ImGuiSettingsHandler* ImGuiSettingsHandler_ImGuiSettingsHandler(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiSettingsHandler();
}
CIMGUI_API void ImGuiSettingsHandler_destroy(ImGuiSettingsHandler* self)
{
    self->~ImGuiSettingsHandler();
}
CIMGUI_API ImGuiMetricsConfig* ImGuiMetricsConfig_ImGuiMetricsConfig(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiMetricsConfig();
}
CIMGUI_API void ImGuiMetricsConfig_destroy(ImGuiMetricsConfig* self)
{
    self->~ImGuiMetricsConfig();
}
CIMGUI_API ImGuiStackLevelInfo* ImGuiStackLevelInfo_ImGuiStackLevelInfo(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiStackLevelInfo();
}
CIMGUI_API void ImGuiStackLevelInfo_destroy(ImGuiStackLevelInfo* self)
{
    self->~ImGuiStackLevelInfo();
}
CIMGUI_API ImGuiStackTool* ImGuiStackTool_ImGuiStackTool(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiStackTool();
}
CIMGUI_API void ImGuiStackTool_destroy(ImGuiStackTool* self)
{
    self->~ImGuiStackTool();
}
CIMGUI_API ImGuiContextHook* ImGuiContextHook_ImGuiContextHook(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiContextHook();
}
CIMGUI_API void ImGuiContextHook_destroy(ImGuiContextHook* self)
{
    self->~ImGuiContextHook();
}
CIMGUI_API ImGuiContext* ImGuiContext_ImGuiContext(void* self,ImFontAtlas* shared_font_atlas)
{
    return IM_PLACEMENT_NEW(self) ImGuiContext(shared_font_atlas);
}
CIMGUI_API void ImGuiContext_destroy(ImGuiContext* self)
{
    self->~ImGuiContext();
}
CIMGUI_API ImGuiWindow* ImGuiWindow_ImGuiWindow(void* self,ImGuiContext* context,const char* name)
{
    return IM_PLACEMENT_NEW(self) ImGuiWindow(context,name);
}
...
CIMGUI_API void ImGuiWindow_Rect(ImRect *pOut,const ImGuiWindow* self)
{
    *pOut = self->Rect();
}
...
CIMGUI_API void ImGuiWindow_TitleBarRect(ImRect *pOut,const ImGuiWindow* self)
{
...
CIMGUI_API void ImGuiWindow_MenuBarRect(ImRect *pOut,const ImGuiWindow* self)
{
    *pOut = self->MenuBarRect();
}
CIMGUI_API ImGuiTabItem* ImGuiTabItem_ImGuiTabItem(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTabItem();
}
CIMGUI_API void ImGuiTabItem_destroy(ImGuiTabItem* self)
{
    self->~ImGuiTabItem();
}
CIMGUI_API ImGuiTabBar* ImGuiTabBar_ImGuiTabBar(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTabBar();
}
...
CIMGUI_API ImGuiTableColumn* ImGuiTableColumn_ImGuiTableColumn(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableColumn();
}
CIMGUI_API void ImGuiTableColumn_destroy(ImGuiTableColumn* self)
{
    self->~ImGuiTableColumn();
}
CIMGUI_API ImGuiTableInstanceData* ImGuiTableInstanceData_ImGuiTableInstanceData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableInstanceData();
}
CIMGUI_API void ImGuiTableInstanceData_destroy(ImGuiTableInstanceData* self)
{
    self->~ImGuiTableInstanceData();
}
CIMGUI_API ImGuiTable* ImGuiTable_ImGuiTable(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTable();
}
CIMGUI_API void ImGuiTable_destroy(ImGuiTable* self)
{
    self->~ImGuiTable();
}
CIMGUI_API ImGuiTableTempData* ImGuiTableTempData_ImGuiTableTempData(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableTempData();
}
CIMGUI_API void ImGuiTableTempData_destroy(ImGuiTableTempData* self)
{
    self->~ImGuiTableTempData();
}
CIMGUI_API ImGuiTableColumnSettings* ImGuiTableColumnSettings_ImGuiTableColumnSettings(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableColumnSettings();
}
CIMGUI_API void ImGuiTableColumnSettings_destroy(ImGuiTableColumnSettings* self)
{
    self->~ImGuiTableColumnSettings();
}
CIMGUI_API ImGuiTableSettings* ImGuiTableSettings_ImGuiTableSettings(void* self)
{
    return IM_PLACEMENT_NEW(self) ImGuiTableSettings();
}
CIMGUI_API void ImGuiTableSettings_destroy(ImGuiTableSettings* self)
{
    self->~ImGuiTableSettings();
}
...
CIMGUI_API void igCalcItemSize(ImVec2 *pOut,const ImVec2* size,float default_w,float default_h)
{
...
CIMGUI_API void igTabBarQueueReorderFromMousePos(ImGuiTabBar* tab_bar,const ImGuiTabItem* tab,const ImVec2* mouse_pos)
{
...
CIMGUI_API void igTabItemLabelAndCloseButton(ImDrawList* draw_list,const ImRect* bb,ImGuiTabItemFlags flags,const ImVec2* frame_padding,const char* label,ImGuiID tab_id,ImGuiID close_button_id,bool is_contents_visible,bool* out_just_closed,bool* out_text_clipped)
{
...
CIMGUI_API void igRenderText(const ImVec2* pos,const char* text,const char* text_end,bool hide_text_after_hash)
{
    return ImGui::RenderText(*pos,text,text_end,hide_text_after_hash);
}
CIMGUI_API void igRenderTextWrapped(const ImVec2* pos,const char* text,const char* text_end,float wrap_width)
{
...
CIMGUI_API void igRenderFrame(const ImVec2* p_min,const ImVec2* p_max,ImU32 fill_col,bool border,float rounding)
{
    return ImGui::RenderFrame(*p_min,*p_max,fill_col,border,rounding);
}
CIMGUI_API void igRenderFrameBorder(const ImVec2* p_min,const ImVec2* p_max,float rounding)
{
    return ImGui::RenderFrameBorder(*p_min,*p_max,rounding);
}
CIMGUI_API void igRenderColorRectWithAlphaCheckerboard(ImDrawList* draw_list,const ImVec2* p_min,const ImVec2* p_max,ImU32 fill_col,float grid_step,const ImVec2* grid_off,float rounding,ImDrawFlags flags)
{
...
CIMGUI_API void igRenderMouseCursor(const ImVec2* pos,float scale,ImGuiMouseCursor mouse_cursor,ImU32 col_fill,ImU32 col_border,ImU32 col_shadow)
{
    return ImGui::RenderMouseCursor(*pos,scale,mouse_cursor,col_fill,col_border,col_shadow);
}
CIMGUI_API void igRenderArrow(ImDrawList* draw_list,const ImVec2* pos,ImU32 col,ImGuiDir dir,float scale)
{
    return ImGui::RenderArrow(draw_list,*pos,col,dir,scale);
}
CIMGUI_API void igRenderBullet(ImDrawList* draw_list,const ImVec2* pos,ImU32 col)
{
    return ImGui::RenderBullet(draw_list,*pos,col);
}
CIMGUI_API void igRenderCheckMark(ImDrawList* draw_list,const ImVec2* pos,ImU32 col,float sz)
{
    return ImGui::RenderCheckMark(draw_list,*pos,col,sz);
}
CIMGUI_API void igRenderArrowPointingAt(ImDrawList* draw_list,const ImVec2* pos,const ImVec2* half_sz,ImGuiDir direction,ImU32 col)
{
...
CIMGUI_API bool igArrowButtonEx(const char* str_id,ImGuiDir dir,const ImVec2* size_arg,ImGuiButtonFlags flags)
{
...
CIMGUI_API int igPlotEx(ImGuiPlotType plot_type,const char* label,float(*values_getter)(void* data,int idx),void* data,int values_count,int values_offset,const char* overlay_text,float scale_min,float scale_max,const ImVec2* frame_size)
{
...
CIMGUI_API void igShadeVertsLinearColorGradientKeepAlpha(ImDrawList* draw_list,int vert_start_idx,int vert_end_idx,const ImVec2* gradient_p0,const ImVec2* gradient_p1,ImU32 col0,ImU32 col1)
{
